...
public class ExtentListeners extends DataDrivenTest implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String screenshotPath = captureScreenshot(result.getTestClass().getRealClass().getSimpleName() + "_" + fail + "_" + timestamp() + ".png");
